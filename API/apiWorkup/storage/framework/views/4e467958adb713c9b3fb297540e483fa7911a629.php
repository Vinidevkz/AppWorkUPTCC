    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar" style="width: 300px;">
        <div class="offcanvas-header">
            <a class="navbar-brand" href="#">
                ...
                <img src="<?php echo e(url('/assets/img/home/WUPlogo.png')); ?>" alt="Logo Mobile" class="logo-mobile">
            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="partner-container">
                                ...
                                <img src="<?php echo e(url('/assets/img/home/helphouse.jpeg')); ?>" alt="Logo Empresa 1" class="partner-logo">
                                <img src="<?php echo e(url('/assets/img/home/acheaqui.png')); ?>" alt="Logo Empresa 2" class="partner-logo">
                                <img src="<?php echo e(url('/assets/img/home/conectec.jpeg')); ?>" alt="Logo Empresa 3" class="partner-logo">
                            </div>

                            <div class="col-lg-12 col-md-12 col-sm-12">

                                <p class="copyright">Copyright © 2024 <img href="#"><img id="logo-footer"
                                        src="<?php echo e(url('/assets/img/login/workuplogo.png')); ?>" alt="Descrição da imagem"
                                        class="rounded"></a>.</p>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH C:\Users\Admin\Documents\GitHub\AppWorkUPTCC\API\apiWorkup\resources\views//homeWorkUp.blade.php ENDPATH**/ ?>