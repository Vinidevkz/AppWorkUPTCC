...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('assets/css/dynamo.css')); ?>">
    
    <link rel="stylesheet" href="<?php echo e(url('assets/css/dynamoPadrao.css')); ?>">
...
<body class="dark-mode">
    ...
    <section class="secao" id="home">
        ...
        <header class="fixed-top">
            <img class="logo" src="<?php echo e(url('assets/img/dynamo/logo.png')); ?>">
            <nav>
                <ul class="nav-itens">
    ...
    <section id="equipe" class="equipe secao">
        ...
        <div class="embrulho">
            ...
            <div class="wrap-carrossel">
                ...
                <img id="backBtn" src="<?php echo e(url('assets/img/dynamo/bckBtn.png')); ?>" class="btn-carrossel" id="backBtn">
                ...
                <div class="carrossel">
                    ...
                    <div class="carrossel-div-1">
                        ...
                        <div class="card">
                            <img id="backBtn" src="<?php echo e(url('assets/img/dynamo/feh.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/edu.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/muh.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/vini.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/felipe.png')); ?>" alt="img" draggable="false">
                    ...
                    <div class="carrossel-div-1">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/dan.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/ale.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/papi.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/chad.png')); ?>" alt="img" draggable="false">
                        ...
                        <div class="card">
                            <img src="<?php echo e(url('assets/img/dynamo/daniel.png')); ?>" alt="img" draggable="false">
                ...
                <img id="nextBtn" src="<?php echo e(url('assets/img/dynamo/nextBtn.png')); ?>" class="btn-carrossel" id="nextBtn">
        ...
        <div class="container container-parceiros d-flex flex-column">
            <div class="row flex-column flex-lg-row">
                <div class="col col-12 col-md-12 col-lg-6 parceiros-div-1">
                    <img id="mainImage" src="<?php echo e(url('assets/img/dynamo/sevenLogo.png')); ?>" alt="Imagem Principal" class="main-image bg-white">
                </div>
        ...
        <div class="container btns-parceiros">
            <div class="row">
                <div class="col col-lg-2 col-md-3 col-4 box-img">
                    <img src="<?php echo e(url('assets/img/dynamo/sevenLogo.png')); ?>" alt="Imagem 1" class="thumbnail"
                        onclick="changeImage('assets/img/dynamo/sevenLogo.png')">
                </div>

                <div class="col col-lg-2 col-md-3 col-4 box-img">
                    <img src="<?php echo e(url('assets/img/dynamo/chronosLogo.png')); ?>" alt="Imagem 2" class="thumbnail"
                        onclick="changeImage('assets/img/dynamo/chronosLogo.png')">
                </div>


                <div class="col col-lg-2 col-md-3 col-4 box-img">
                    <img src="<?php echo e(url('assets/img/dynamo/sunsetLogo.png')); ?>" alt="Imagem 3" class="thumbnail"
    ...
    <script src="<?php echo e(url('assets/js/dynamo/dark-mode.js')); ?>"></script>
    <script src="<?php echo e(url('assets/js/dynamo/animacao.js')); ?>"></script>
    <script src="<?php echo e(url('assets/js/dynamo/card-equipe.js')); ?>"></script>
    <script src="<?php echo e(url('assets/js/dynamo/carrossel.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\Admin\Documents\GitHub\AppWorkUPTCC\API\apiWorkup\resources\views/home.blade.php ENDPATH**/ ?>