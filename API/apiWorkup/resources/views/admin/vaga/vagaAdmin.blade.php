      ...
      <div class="container md-4">
        <div class="card bg-dark" style="--bs-bg-opacity: .8;">
          <div class="card-header">
            <h1>Vagas <span class="bi bi-people"></span></h1>
            <a href="/cadastrarVaga" class="btn btn-outline-info float-end"><span class="bi bi-plus-circle"></span>&nbsp;Adicionar usuários</a>
          </div>
          <div class="card-body">
            <table class="table table-dark table-striped">
              <thead>
                <tr>
                  ...
                  <th><a href="{{ route('vagas.index') }}" class="btn btn-outline-primary">status</th>
                  @else
                  <th><a href="{{ route('vagas.index', ['order' => 'status']) }}" class="btn btn-outline-primary">Status</a>
                  @endif
                  <th>Ações</th>
                </tr>
              </thead>
