      ...
      <div class="aside-container">
        <aside>
          <div class="aside-sidebar d-flex flex-column">
            ...
            <div class="d-flex">
              <a href="/admin" class="aside-active d-flex flex-row align-items-center h5">
            ...
            <div class="d-flex">
              <a href="/verUsuario" class="d-flex flex-row align-items-center h5">
            ...
            <div class="d-flex">
              <a href="/verVaga" class="d-flex flex-row align-items-center h5">
            ...
            <div class="d-flex">
              <a href="/verEmpresa" class="d-flex flex-row align-items-center h5">
            ...
            <div class="">
              <a href="/infoAdmin" class="d-flex flex-row align-items-center h5">
            ...
            <div class="d-flex">
              <a href="/SuporteAdmin" class="d-flex flex-row align-items-center h5" id="btn-support">
                <span class="material-symbols-outlined p-2">info</span>
                Suporte
              </a>
            </div>
            ...
            <div class="d-flex">
              <a href="" class="d-flex flex-row align-items-center h5" id="btn-exit">
