                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-6 text-center text-xl-start">
                            <img src="{{url('/assets/img/home/workuplogo.png')}}" alt="Logoheader" class="logoheader mb-3">
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
                        <img class="img-fluid rounded-4 my-0" src="{{url('/assets/img/home/cell2.png')}}" alt="imgHeader" />
                    </div>
                </div>
            </div>
        </header>
