...
const ApisUrls = {
  //login
  apiNgrok: "http://76bf-200-53-194-126.ngrok-free.app/api/usuario/login",
  apiEmulador: "http://10.0.2.2:8000/api/usuario/login",
  apiNgrokUsuario: "http://76bf-200-53-194-126.ngrok-free.app/api/usuario/",
  apiEmuladorUsuario: "http://10.0.2.2:8000/api/usuario/",
  apiNgrokAlterar: "",
  //cadastro
  apiNgrokCad: "http://76bf-200-53-194-126.ngrok-free.app/api/usuario",
  apiEmuladorCad: "http://10.0.2.2:8000/api/usuario",
  //pegar vagas
  apiNgrokVaga: "http://76bf-200-53-194-126.ngrok-free.app/api/vaga/",
  apiEmuladorVaga: "http://10.0.2.2:8000/api/vaga/",
  //pegar area de interesse
  apiNgrokArea: "http://76bf-200-53-194-126.ngrok-free.app/api/areavaga",
  apiEmuladorArea: "http://10.0.2.2:8000/api/areavaga",
  //pegar id
  apiNgrokId: "http://76bf-200-53-194-126.ngrok-free.app/api/usuario/",
  ...
  apiNgrokVagaPesquisa:
    "http://76bf-200-53-194-126.ngrok-free.app/api/vaga/busca/",

  //usuario se candidatar
  apiEmuladorUsuarioVaga: "http://10.0.2.2:8000/api/vagaUsuario",
  apiNgrokUsuarioVaga:
    "http://76bf-200-53-194-126.ngrok-free.app/api/vagaUsuario",
  apiNgrokVerificarCandidatura: "http://76bf-200-53-194-126.ngrok-free.app/api/verificarCandidatura/",
  ...
  apiNgrokSalvarVaga:
    "http://76bf-200-53-194-126.ngrok-free.app/api/salvarVaga/",
    ...
    apiNgrokVerificarSalvarVaga: "http://76bf-200-53-194-126.ngrok-free.app/api/verificarSalvarVaga",


    //Urls Empresa
    apiNgrokEmpresa: "http://76bf-200-53-194-126.ngrok-free.app/api/showempresa/"
};
