...
const ApisUrls = {
  //login
  apiNgrok: "http://4cdf-200-53-199-197.ngrok-free.app/api/usuario/login",
  apiEmulador: "http://10.0.2.2:8000/api/usuario/login",
  apiNgrokUsuario: "https://4cdf-200-53-199-197.ngrok-free.app/api/usuario/",
  apiEmuladorUsuario: "http://10.0.2.2:8000/api/usuario/",
  apiNgrokAlterar: "",
  //cadastro
  apiNgrokCad: "https://4cdf-200-53-199-197.ngrok-free.app/api/usuario",
  apiEmuladorCad: "http://10.0.2.2:8000/api/usuario",
  //pegar vagas
  apiNgrokVaga: "https://4cdf-200-53-199-197.ngrok-free.app/api/vagaApp/",
  apiEmuladorVaga: "http://10.0.2.2:8000/api/vagaApp/",
  //pegar area de interesse
  apiNgrokArea: "https://4cdf-200-53-199-197.ngrok-free.app/api/areavaga",
  apiEmuladorArea: "http://10.0.2.2:8000/api/areavaga",
  //pegar id
  apiNgrokId: "https://4cdf-200-53-199-197.ngrok-free.app/api/usuario/",
  ...
  apiNgrokVagaPesquisa:
    "https://4cdf-200-53-199-197.ngrok-free.app/api/vaga/busca/",

  //usuario se candidatar
  apiEmuladorUsuarioVaga: "http://10.0.2.2:8000/api/vagaUsuario",
  apiNgrokUsuarioVaga:
    "https://4cdf-200-53-199-197.ngrok-free.app/api/vagaUsuario",
  apiNgrokVerificarCandidatura: "https://4cdf-200-53-199-197.ngrok-free.app/api/verificarCandidatura/",
  ...
  apiNgrokSalvarVaga:
    "https://4cdf-200-53-199-197.ngrok-free.app/api/salvarVaga/",
    ...
    apiNgrokVerificarSalvarVaga: "https://4cdf-200-53-199-197.ngrok-free.app/api/verificarSalvarVaga",


    //Urls Empresa
    apiNgrokEmpresa: "https://4cdf-200-53-199-197.ngrok-free.app/api/showempresa/",
    apiEmuladorEmpresa: "http://10.0.2.2:8000/api/showempresa/",

    //Urls Linguas
    apiEmuladorLinguas: "http://10.0.2.2:8000/api/linguas",
    apiNgrokLinguas: "https://4cdf-200-53-199-197.ngrok-free.app/api/linguas",

    //Urls Escolas
    apiEmuladorEscolas: "http://10.0.2.2:8000/api/escolas",
    apiNgrokEscolas: "https://4cdf-200-53-199-197.ngrok-free.app/api/escolas",

    //Urls Denuncias
    apiNgrokDenunciarVaga: "https://4cdf-200-53-199-197.ngrok-free.app/api/denunciarVaga",
    apiEmuladorDenunciarVaga: "http://10.0.2.2:8000/api/denunciarVaga",
    apiNgrokDenunciarEmpresa: "https://4cdf-200-53-199-197.ngrok-free.app/api/denunciaempresa",
    apiEmuladorDenunciarEmpresa: "http://10.0.2.2:8000/api/denunciaempresa",

    //Urls ver candidaturas do usuario
    apiNgrokMinhasVagas: "https://4cdf-200-53-199-197.ngrok-free.app/api/minhasvagas",
    apiEmuladorMinhasVagas: "http://10.0.2.2:8000/api/minhasvagas",

    //Urls ver vaga pro id da empresa
    apiNgrokVagaEmpresa: 'https://4cdf-200-53-199-197.ngrok-free.app/api/showvagaempresa/',
    ...
    apiNgrokVagaPorArea: 'https://4cdf-200-53-199-197.ngrok-free.app/api/vagaporarea',
    

    //Urls ver vaga baseado na área de interesse
    apiEmuladorOutrasVagas: 'http://10.0.2.2:8000/api/outrasvagas',
    apiNgrokOutrasVagas: 'https://4cdf-200-53-199-197.ngrok-free.app/api/outrasvagas',

    //Urls Notificacoes
    apiNgrokNotificacoes: 'https://4cdf-200-53-199-197.ngrok-free.app/api/notificacoes',
    apiEmuladorNotificacoes: 'http://10.0.2.2:8000/api/notificacoes',

    //Urls chats
    apiNgrokChats: 'https://4cdf-200-53-199-197.ngrok-free.app/api/chatsusuario',
    apiEmuladorChats: 'http://10.0.2.2:8000:/api/chatsusuario ',

    //Urls Mensagens
    apiNgrokMensagens: 'https://4cdf-200-53-199-197.ngrok-free.app/api/mensagens',
    apiEmuladorMensagens: 'http://10.0.2.2:8000/api/mensagens',

    apiNgrokMandarMensagem: 'https://4cdf-200-53-199-197.ngrok-free.app/api/mandarMensagem',
    apiEmuladorMandarMensagem: 'http://10.0.2.2:8000/api/mandarMensagem',

    apiNgrokMensagemMaisRecente: 'https://4cdf-200-53-199-197.ngrok-free.app/api/mensagemMaisRecente',
    apiEmuladorMensagemMaisRecente: 'http://10.0.2.2:8000/api/mensagemMaisRecente',

    //Urls Posts
    apiNgrokPosts: 'https://4cdf-200-53-199-197.ngrok-free.app/api/todosPosts',
    apiEmuladorPosts: 'http://10.0.2.2:8000/api/todosPosts',

    apiNgrokPostsEmpresa: 'https://4cdf-200-53-199-197.ngrok-free.app/api/postsempresa',
