...
const ApisUrls = {
  //login
  apiNgrok: "http://16ba-200-53-194-126.ngrok-free.app/api/usuario/login",
  apiEmulador: "http://10.0.2.2:8000/api/usuario/login",
  apiNgrokUsuario: "http://16ba-200-53-194-126.ngrok-free.app/api/usuario/",
  apiEmuladorUsuario: "http://10.0.2.2:8000/api/usuario/",
  apiNgrokAlterar: "",
  //cadastro
  apiNgrokCad: "http://16ba-200-53-194-126.ngrok-free.app/api/usuario",
  apiEmuladorCad: "http://10.0.2.2:8000/api/usuario",
  //pegar vagas
  apiNgrokVaga: "http://16ba-200-53-194-126.ngrok-free.app/api/vagaApp/",
  apiEmuladorVaga: "http://10.0.2.2:8000/api/vagaApp/",
  //pegar area de interesse
  apiNgrokArea: "http://16ba-200-53-194-126.ngrok-free.app/api/areavaga",
  apiEmuladorArea: "http://10.0.2.2:8000/api/areavaga",
  //pegar id
  apiNgrokId: "http://16ba-200-53-194-126.ngrok-free.app/api/usuario/",
  ...
  apiNgrokVagaPesquisa:
    "http://16ba-200-53-194-126.ngrok-free.app/api/vaga/busca/",
  ...
  apiNgrokSalvarVaga:
    "http://16ba-200-53-194-126.ngrok-free.app/api/salvarVaga/",
    ...
    apiNgrokVerificarSalvarVaga: "http://16ba-200-53-194-126.ngrok-free.app/api/verificarSalvarVaga",


    //Urls Empresa
    apiNgrokEmpresa: "http://16ba-200-53-194-126.ngrok-free.app/api/showempresa/"
};
