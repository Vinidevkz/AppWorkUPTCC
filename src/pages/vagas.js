...
export default function Vaga({ navigation }) {
  ...
  const { apiNgrokVaga, apiNgrokUsuarioVaga, apiNgrokUsuarioVagaCancelar, apiNgrokVerificarCandidatura, apiEmuladorVaga, apiEmuladorUsuarioVaga, apiEmuladorUsuarioVagaCancelar, apiEmuladorVerificarCandidatura } = ApisUrls;
