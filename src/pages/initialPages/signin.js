  ...
  return (
    <SafeAreaView style={styles.SafeAreaView}>
        <View style={styles.loginCont}>
            <Image source={require('../../../assets/icons/workuplogo.png')} style={styles.workuplogo}/>
            <Text style={[styles.DMSansBold, styles.title]}>Login</Text>
                <View style={styles.inputCont}>
                <FontAwesome6 name={'user-large'} size={25} color={'#1b1b1b'} />
                <TextInput placeholder="Digite seu nome de usuário" style={[styles.DMSansRegular, styles.input]}/>
                </View>

                <View style={styles.inputCont}>
                <FontAwesome6 name={'unlock'} size={25} color={'#1b1b1b'} />
                <TextInput placeholder="Digite sua senha" style={[styles.DMSansRegular, styles.input]} secureTextEntry={!passwordVisible}/>
                <TouchableOpacity onPress={() => setPasswordVisible(!passwordVisible)}>
                 <FontAwesome6 name={passwordVisible? 'eye-slash' : 'eye'} size={25} color={'#1b1b1b'} />
                </TouchableOpacity>
                </View>
