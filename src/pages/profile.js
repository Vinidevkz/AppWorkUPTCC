  ...
  return (
    <SafeAreaView>
      <View style={styles.containerTop}>
          <Text style={[styles.DMSansBold, styles.title]}>Meu Perfil</Text>
          <TouchableOpacity onPress={() => navigation.navigate('Configurações')}>
            <Octicons name="gear" size={30} color="#1b1b1b" />
          </TouchableOpacity>
      </View>
          ...
          <View style={styles.profileCont}>
            ...
            <View style={styles.profileLinksCont}>
              ...
              <View style={styles.linkLine}>
                <Text style={[styles.DMSansBold, styles.linkTitle]}>
                  Instagram:{" "}
                </Text>
                <TouchableOpacity style={styles.linkButton}>
                  <Text style={[styles.DMSansRegular, styles.linkText]}>
                    {" "}
                    @marcosandradevn2
                  </Text>
                </TouchableOpacity>
